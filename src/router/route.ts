				...
				children: [
					{
						...
						name: 'templateList',
						component: () => import('/@/views/templatePage/templateList/index.vue'),
						meta: {
							title: 'message.router.templateList',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
				 ...
				 children: [
					{
						...
						meta: {
							title: 'message.router.projectList',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
