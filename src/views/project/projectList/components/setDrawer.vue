<template>
    <el-drawer v-model="state.show" title="修改项目" direction="rtl" size="50%">
    ...
    margin-top: 30px;" :model="ruleForm" :rules="rules" label-width="auto" class="demo-ruleForm" :size="formSize"
        ...
        <div class="buttons" style="position: absolute; bottom: 5%; right: 11%;">
            <el-button type="primary" size="default" :icon="Finished" :loading="state.loading"
                @click.stop="mySetProject">修改</el-button>
        </div>
...
import { setProject } from '/@/api/singlePage/index.js';
...
export default {
    ...
    setup(props, { emit }) {
        ...
        return {
            Finished, state, open, close, ruleFormRef, formSize, rules, ruleForm, templateListPopup,
            openTemplateList,
            selectTemplate,
            regionNums,
            mySetProject,
